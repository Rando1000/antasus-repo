...
<div class="container pb-5 mb-sm-4">
    ...
    <div class="row mb-3">
        <div class="col-sm-4 mb-2">
            <div class="bg-dark p-4 text-white text-center"><span class="font-weight-semibold mr-2">Shipped via:</span>UPS Ground</div>
        </div>
        <div class="col-sm-4 mb-2">
            <div class="bg-dark p-4 text-white text-center"><span class="font-weight-semibold mr-2">Status:</span>Quality check</div>
        </div>
        <div class="col-sm-4 mb-2">
            <div class="bg-dark p-4 text-white text-center"><span class="font-weight-semibold mr-2">Expected date:</span>June 17, 2021</div>
        </div>
    </div>
    <!-- Progress-->
    <div class="steps">
