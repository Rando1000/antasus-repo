    ...
    <div class="site-base--left-banner">
        <div class="site-base--left-banner--full">
            <div id="banner-skyscraper-left" class="">
                <div id="liberty-srpb-sky-atf-left"></div>
            </div>
        </div>
    </div>
                ...
                <section id="home-ctgrs" class="l-container-row contentbox">
                    ...
                    <div class="no-padding clearfix position-relative">
                        <ul id="home-ul-ctgrs" class="itemlist-padded treelist">
                            <li class="">
                                <a class="text-link-secondary treelist-headline" href="markets/categories/{{$category->id}}">
            ...
            <section id="viewad-cntnt" class="l-row a-double-margin l-container-row">
                ...
                <section id="home-ads" class="a-double-margin l-container-row">
                    ...
                    <ul class="tilelist">
                        ...
                        @foreach ($newer as $product)
                            <li class="itemtile-fullpic">
                                <div class="itemtile-header">
                                    <a href="market/categories/$category->id/product/$product->id'">
                                        <img alturl="https://s20.directupload.net/images/210703/e2c2bncb.png" 0.5 src="{{asset('storage/'.$product->pictures)}}" alt="https://s20.directupload.net/images/210703/e2c2bncb.png" 0.5>
                                    </a>
                                </div>
                            ...
                            <li class="itemtile-fullpic">
                                <div class="itemtile-header">
                                    <a href="/s-anzeige/hessnatur-wickelbody-wolle-seide-kurzarm-body/1811090126-22-10423">
                                        <img alt="" src="" srcset="https://i.ebayimg.com/00/s/MTIwMFgxNjAw/z/OkcAAOSwI1pg4B1-/$_12.JPG 2x">
                                    </a>
                                </div>
                                <div class="itemtile-body">
                                    <h7 class="itemtile-title">
