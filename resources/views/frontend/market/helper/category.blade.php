                        ...
                        <!-- <ul>
                            ...
                            <li>
                                <a class="text-link-secondary" href="{{route('frontend.categories', ["id" => $child->id])}}">
                                    {{$child->name}}
                                </a><span class="browsebox-facet text-light"> {{$child->productsCount}}</span>
                            </li>
                            @endforeach
                            @endif
                         </ul>  -->
            ...
            <li class="itemtile-fullpic">
                <div class="itemtile-header">
                    <a href="{!! route('frontend.categories.product.show', ["category" => $category->id, "product" => $product->id]) !!}">
                        <img alt="/public/img/brand/logo-zerissen.png" src="{{asset('storage/'.$product->pictures)}}" srcset="{{asset('storage/'.$product->pictures)}}" 0.5>
                    </a>
                </div>
