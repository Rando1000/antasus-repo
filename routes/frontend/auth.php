...
Route::group(['as' => 'auth.'], function () {
    ...
    Route::group(['middleware' => 'guest'], function () {
        ...
        Route::get('/ethereum/signature', [Web3AuthController::class, 'signature'])->name('metamask.signature');
        

        Route::post('/ethereum/authenticate', [Web3AuthController::class, 'authenticate'])->name('metamask.authenticate');
    });
});
